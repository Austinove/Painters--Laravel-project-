<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
    <div class="container">
    <a class="navbar-brand" href="index.html">House<span>Painter</span></a>
    ...
    <div class="collapse navbar-collapse" id="ftco-nav">
        ...
        <li class="nav-item active"><a href="index.html" class="nav-link"><i class="fa fa-home" aria-hidden="true"></i> Home</a></li>
        <li class="nav-item"><a href="index.html" class="nav-link"><i class="fa fa-question-circle" aria-hidden="true"></i> Help</a></li>
        {{-- @if (Route::has('login'))
                @auth --}}
                ...
                @endauth
        @endif --}}
        <li class="nav-item"><a href="contact.html" class="nav-link"><i class="fa fa-phone" aria-hidden="true"></i> Contact</a></li>
